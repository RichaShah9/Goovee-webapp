...
/* harmony default export */ __webpack_exports__["default"] = (Object(next_router__WEBPACK_IMPORTED_MODULE_4__["withRouter"])(ActiveLink)); // export default withRouter(({ router, children, as, href, ...rest }) => (
//   <Link {...rest} href={href} as={as}>
//     {React.cloneElement(Children.only(children), {
//       className:
//         router.asPath === href || router.asPath === as ? `${classNames(classes.active, classes.link)}` : classes.link
//     })}
//   </Link>
// ));
...
//# sourceMappingURL=index.js.f4ff9342e69270efbd61.hot-update.js.map